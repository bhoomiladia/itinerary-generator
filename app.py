...
async def suggest_place(req: ChatRequest):
    ...
    suggestion_task = Task(
        description=(
            ...
            "3. If suggesting multiple options, present them clearly\n"
            "4. For first messages, introduce yourself briefly\n\n"
            "5. Dont ask too many questions, give quick suggestions"
